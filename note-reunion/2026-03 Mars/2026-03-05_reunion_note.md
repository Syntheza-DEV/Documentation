# [Weekly] – Déploiement, Mobile & Trust Factor
...
* **Discussion** :
  Un problème au niveau du déploiement a été identifié et remonté. Ilhan a pris en charge l'investigation et le correctif.

* **Décision** :
  Le problème de déploiement est corrigé et la procédure de déploiement reste inchangée pour l'instant.
...
* **Décision** :
  Considérer la base mobile + auth comme fonctionnelle. Prochaine étape : stabilisation et tests utilisateurs.
...
* **Décision** :
  Nouveau comportement adopté. À surveiller en prod pour confirmer qu'il n'y a plus de résidus de session.
...
* **Décision** :
  Valider cette première version pour amélioration de la pédagogie utilisateur. Reste à fiabiliser le déploiement.
...
|--------|-------------|----------|--------|
| Vérifier et stabiliser le flux de déploiement pour les changements frontend | @Raphael, @Ilhan | 11/03/2026 | 🔄 En cours |
| Tester les 5 pages mobiles avec les flows Login / Register / Logout / Changement de mot de passe | @Ilhan | 11/03/2026 | ⏳ À faire |
| Surveiller le nouveau comportement du logout web en prod | @Raphael | 11/03/2026 | ⏳ À faire |
| Vérifier que la popup trust factor est bien déployée et visible en prod | @Raphael | 11/03/2026 | ⏳ À faire |
